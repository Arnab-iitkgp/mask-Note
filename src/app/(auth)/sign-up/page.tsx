////do the debounced part of the username
'use client';
...
//           console.log("API Request URL:", `/api/check-username-unique?username=${username}`);
// console.log("Debounced Username Value:", username);
